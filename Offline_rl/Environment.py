...
# https://colab.research.google.com/drive/1oJOYlAIOl9d1JjlutPY66KmfPkwPCgEE?usp=sharing#scrollTo=9mydlYlB83ld
...
RENDER_DICT = {v:k for k, v in STR_AMP.items()}
RENDER_DICT[EMPTY] = ' '
RENDER_DICT[START] = ' '
...
class GridEnv(object):
  def __init__(self, gridsepc, teps = 0.0, observation_type = OBS_ONEHOT, dim_obs=8):
  ...
  def initial_state_distributions(self):
